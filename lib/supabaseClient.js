...
// Supabase's own background token-refresh timer keeps firing while the app
// is backgrounded, and iOS refuses Keychain reads at that point ("User
// interaction is not allowed" from SecureStore) -- this is Supabase's
// documented fix: only run the refresh loop while the app is actually in
// the foreground. See
// https://supabase.com/docs/guides/getting-started/tutorials/with-expo-react-native
if (supabase) {
